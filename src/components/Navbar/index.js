              ...
              <div className="col-12">
                  <Navbar bg="light" expand="lg" className="navbar navbar-expand-md navbar-light aradhna_navbarfont" onToggle={this.setNavExpanded} expanded={this.state.navExpanded}>
                      ...
                      <Nav classNameName="mr-auto" className="navbar-nav ml-auto py-md-0">
                        ...
                        :
                        <li className="navbar_nav-item pl-4 pl-md-0 ml-0 ml-md-4">
                            <Nav.Link className="navbar_nav-link dropdown-toggle aradhna_navbarfont"   data-toggle="modal" data-target="#exampleModal" onClick={this.setNavClose}>Featured
                            </Nav.Link>
                        </li>
                        }
                        <li className="navbar_nav-item pl-4 pl-md-0 ml-0 ml-md-4">
                        ...
                        ?
                        <li className="navbar_nav-item pl-4 pl-md-0 ml-0 ml-md-4">
                        <Nav.Link className="navbar_nav-link dropdown-toggle aradhna_navbarfont" href="/" onClick={() => firebase.auth().signOut()}>Sign Out
                        </Nav.Link>
                        </li>
                        :
                        <li className="navbar_nav-item pl-4 pl-md-0 ml-0 ml-md-4">
                            <Nav.Link className="navbar_nav-link dropdown-toggle aradhna_navbarfont"  data-toggle="modal" data-target="#exampleModal">
                             <b>Sign In</b>
                            </Nav.Link>
                        </li>
                        }  
